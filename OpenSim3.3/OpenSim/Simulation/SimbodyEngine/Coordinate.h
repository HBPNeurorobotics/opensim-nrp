...
// TruPhysics begin
public:
        const SimTK::ConstraintIndex& getPrescribedConstraintIndex() const { return _prescribedConstraintIndex; }
        const SimTK::ConstraintIndex& getLockedConstraintIndex() const { return _lockedConstraintIndex; }
        const SimTK::ConstraintIndex& getClampedConstraintIndex() const { return _clampedConstraintIndex; }

        const SimTK::MobilizedBodyIndex& getMobilizedBodyIndex() const { return _bodyIndex; }
// TruPhysics end
private:
