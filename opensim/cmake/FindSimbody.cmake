...
#    set(INSTDIR $ENV{SimTK_INSTALL_DIR})
    ...
    if (WIN32)
	    ...
	    set(PROGFILE_DIR "$PROGRAM_FILES_X86") 
	    if (NOT PROGFILE_DIR)
...
message(STATUS "Simbody search paths: ${Simbody_SEARCH_PATHS}")
...
message(STATUS "Simbody include directory: ${Simbody_INCLUDE_DIR}")
message(STATUS "Simbody library          : ${Simbody_LIBRARY}")
message(STATUS "Simbody library (debug)  : ${Simbody_DEBUG_LIBRARY}")

if (Simbody_INCLUDE_DIR AND Simbody_LIBRARY)
  set(Simbody_FOUND TRUE)
  message(STATUS "Set Simbody_FOUND to TRUE")
else()
  if(Simbody_INCLUDE_DIR AND Simbody_DEBUG_LIBRARY)
    set(Simbody_FOUND TRUE)
    message(STATUS "Set Simbody_FOUND to TRUE (debug library)")
  else()
    set(Simbody_FOUND FALSE)
    message(STATUS "Set Simbody_FOUND to FALSE")
  endif()
endif()
